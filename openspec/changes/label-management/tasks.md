...
- [ ] 2.1 Wire `LabelStore` into `App` (`label_store`, `editing: Option<EditState>`, `load_patch` bucket load, `recompute_influence` for overlay status) <!-- agent: rusty-engineer.build, depends_on: [1.3], touches: [src/app.rs] -->
