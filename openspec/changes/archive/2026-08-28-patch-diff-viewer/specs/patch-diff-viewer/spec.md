...
Compare two DROID patches structurally — wiring and settings — ignoring HW module order, patch-wide or scoped to a selected hardware component, and highlight the differences in the signal-flow graph view.
