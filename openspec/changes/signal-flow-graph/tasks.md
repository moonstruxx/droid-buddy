...
- [ ] 2.3 Graph model + topology test suite through the public `build_from_patch` entry point with fixtures: model shape, edge directions, cluster membership, all validation states. Verify: full `cargo test` green including new tests <!-- agent: horst-engineer.build, depends_on: [2.1, 2.2], touches: [src/graph.rs] -->
