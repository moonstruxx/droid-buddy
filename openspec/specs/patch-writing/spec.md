...
Lossless, deterministic, atomic writing of a parsed DROID patch back to a `.ini` file, preserving comments and banners with their sections and refusing to overwrite the source.
